...
def main():
    ...
    process_online_articles(['https://www.nytimes.com/2020/03/19/us/politics/1000-checks-coronavirus-stimulus.html?action=click&module=Top%20Stories&pgtype=Homepage'])
